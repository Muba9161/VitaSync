...
<html lang="en" dir="ltr">
  <head>
    ...
    <link
      rel="shortcut icon"
      type="image/x-icon"
      href="admin/assets/images/brand/favicon.ico"
    />
    ...
    <link
      ...
      type="text/css"
      media="all"
      href="admin/assets/colors/color1.css"
    />
  </head>
  ...
  <body>
    <div class="app sidebar-mini ltr light-mode">
      ...
      <div id="global-loader">
        <img
          src="admin/assets/images/loader.svg"
          class="loader-img"
          alt="Loader"
        />
      </div>
            ...
            <div class="container-fluid main-container">
              <div class="d-flex">
                ...
                <a class="logo-horizontal" href="index.html">
                  <img
                    src="admin/assets/images/brand/logo.png"
                    class="header-brand-img desktop-logo"
                    alt="logo"
                  />
                  <img
                    src="admin/assets/images/brand/logo-3.png"
                ...
                <div class="main-header-center ms-3 d-none d-lg-block">
                  <input
                    ...
                    class="form-control"
                    id="typehead"
                    placeholder="Search for resultsadmin."
                  />
                    ...
                    >
                      <div class="d-flex order-lg-2">
                        ...
                        <div class="dropdown d-flex shopping-cart">
                          ...
                          >
                            <div class="drop-heading border-bottom">
                              <div class="d-flex">
                                <h6
                                  class="mt-1 mb-0 fs-16 fw-semibold text-dark"
                                >
                                  My Shopping Cart
                                </h6>
                                <div class="ms-auto">
                            ...
                            <div class="header-dropdown-list message-menu">
                              <div class="dropdown-item d-flex p-4">
                                ...
                                <span
                                  ...
                                  data-bs-image-src="admin/assets/images/pngs/4.jpg"
                                ></span>
                                <div class="wd-50p">
                                  <h5 class="mb-1">
                              ...
                              <div class="dropdown-item d-flex p-4">
                                ...
                                <span
                                  class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/pngs/6.jpg"
                                ></span>
                                <div class="wd-50p">
                              ...
                              <div class="dropdown-item d-flex p-4">
                                ...
                                <span
                                  class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/pngs/8.jpg"
                                ></span>
                                <div class="wd-50p">
                                  <h5 class="mb-1">
                              ...
                              <div class="dropdown-item d-flex p-4">
                                ...
                                <span
                                  class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/pngs/1.jpg"
                                ></span>
                                <div class="wd-50p">
                              ...
                              <div class="dropdown-item d-flex p-4">
                                ...
                                <span
                                  class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/pngs/3.jpg"
                                ></span>
                                <div class="wd-50p">
                            ...
                            <div class="message-menu message-menu-scroll">
                              <a class="dropdown-item d-flex" href="chat.html">
                                <span
                                  ...
                                  data-bs-image-src="admin/assets/images/users/1.jpg"
                                ></span>
                                <div class="wd-90p">
                                  <div class="d-flex">
                                  ...
                                  <span>Commented on file Guest listadmin</span>
                                </div>
                              </a>
                              <a class="dropdown-item d-flex" href="chat.html">
                                <span
                                  class="avatar avatar-md brround me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/users/15.jpg"
                                ></span>
                                <div class="wd-90p">
                                  <div class="d-flex">
                                  ...
                                  <span>New Meetup Startedadmin</span>
                                </div>
                              </a>
                              <a class="dropdown-item d-flex" href="chat.html">
                                <span
                                  class="avatar avatar-md brround me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/users/12.jpg"
                                ></span>
                                <div class="wd-90p">
                                  <div class="d-flex">
                                  ...
                                  <span>Brizid is in the Warehouseadmin.</span>
                                </div>
                              </a>
                              <a class="dropdown-item d-flex" href="chat.html">
                                <span
                                  class="avatar avatar-md brround me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/users/4.jpg"
                                ></span>
                                <div class="wd-90p">
                                  <div class="d-flex">
                                  ...
                                  <span>New Product Realeaseadmin</span>
                                </div>
                              </a>
                              <a class="dropdown-item d-flex" href="chat.html">
                                <span
                                  class="avatar avatar-md brround me-3 align-self-center cover-image"
                                  data-bs-image-src="admin/assets/images/users/3.jpg"
                                ></span>
                                <div class="wd-90p">
                                  <div class="d-flex">
                                  ...
                                  <span>You have appointment onadmin</span>
                                </div>
                              </a>
                            </div>
                            <div class="dropdown-divider m-0"></div>
                        ...
                        <div class="dropdown d-flex profile-1">
                          ...
                          >
                            <img
                              src="admin/assets/images/users/21.jpg"
                              alt="profile-user"
            ...
            <div class="app-sidebar">
              <div class="side-header">
                <a class="header-brand1" href="index.html">
                  ...
                  />
                  <img
                    src="admin/assets/images/brand/logo-2.png"
                ...
                <ul class="side-menu">
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li>
                        <a href="treeview.html" class="slide-item"> Treeview</a>
                      </li>
                      <li>
                      ...
                      <div class="mega-menu">
                        <div class="">
                          <ul>
                            ...
                            <li>
                              <a href="avatarsquare.html" class="slide-item">
                                Avatar Square</a
                              >
                            </li>
                            <li>
                              <a href="avatar-radius.html" class="slide-item">
                                Avatar Radius</a
                              >
                            </li>
                            <li>
                              <a href="avatar-round.html" class="slide-item">
                                Avatar Rounded</a
                              >
                            </li>
                            <li>
                        ...
                        <div class="">
                          <ul>
                            <li>
                              <a href="listgroup.html" class="slide-item">
                                List Group</a
                              >
                            </li>
                            <li>
                        ...
                        <div class="">
                          <ul>
                            ...
                            <li>
                              <a href="offcanvas.html" class="slide-item">
                                Offcanvas</a
                              >
                            </li>
                            <li>
                              <a href="toast.html" class="slide-item"> toast</a>
                            </li>
                            <li>
                              <a href="scrollspy.html" class="slide-item">
                                Scrollspy</a
                              >
                            </li>
                            <li>
                        ...
                        <div class="">
                          <ul>
                            ...
                            <li>
                              <a href="ribbons.html" class="slide-item">
                                Ribbons</a
                              >
                            </li>
                          </ul>
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li>
                        <a href="email-inbox.html" class="slide-item">
                          Mail-Inbox</a
                        >
                      </li>
                      <li>
                        <a href="email-read.html" class="slide-item">
                          Mail-Read</a
                        >
                      </li>
                      <li>
                      ...
                      <li class="sub-slide">
                        ...
                        <ul class="sub-slide-menu">
                          ...
                          <li>
                            <a href="services.html" class="sub-slide-item">
                              Services</a
                            >
                          </li>
                          <li>
                            <a href="faq.html" class="sub-slide-item"> FAQS</a>
                          </li>
                          <li>
                            <a href="terms.html" class="sub-slide-item">
                              Terms</a
                            >
                          </li>
                          <li>
                            <a href="invoice.html" class="sub-slide-item">
                              Invoice</a
                            >
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="settings.html" class="sub-slide-item">
                              Settings</a
                            >
                          </li>
                          <li>
                            <a href="blog.html" class="sub-slide-item"> Blog</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="empty.html" class="sub-slide-item">
                              Empty Page</a
                            >
                          </li>
                          <li>
                      ...
                      <li>
                        <a href="switcher-1.html" class="slide-item">
                          Switcher</a
                        >
                      </li>
                    </ul>
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li>
                        <a href="add-product.html" class="slide-item">
                          Add Product</a
                        >
                      </li>
                      <li>
                        <a href="wishlist.html" class="slide-item"> Wishlist</a>
                      </li>
                      <li>
                        <a href="checkout.html" class="slide-item"> Checkout</a>
                      </li>
                    </ul>
                  </li>
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li>
                        <a href="file-manager.html" class="slide-item">
                          File Manager</a
                        >
                      </li>
                      <li>
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li class="sub-slide">
                        ...
                        <ul class="sub-slide-menu">
                          <li>
                            <a href="400.html" class="sub-slide-item"> 400</a>
                          </li>
                          <li>
                            <a href="401.html" class="sub-slide-item"> 401</a>
                          </li>
                          <li>
                            <a href="403.html" class="sub-slide-item"> 403</a>
                          </li>
                          <li>
                            <a href="404.html" class="sub-slide-item"> 404</a>
                          </li>
                          <li>
                            <a href="500.html" class="sub-slide-item"> 500</a>
                          </li>
                          <li>
                            <a href="503.html" class="sub-slide-item"> 503</a>
                          </li>
                        </ul>
                      </li>
                    </ul>
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li>
                        <a href="maps1.html" class="slide-item">Leaflet Maps</a>
                      </li>
                      <li>
                        <a href="maps2.html" class="slide-item">Mapel Maps</a>
                      </li>
                      <li>
                        <a href="maps.html" class="slide-item">Vector Maps</a>
                      </li>
                    </ul>
                  </li>
                  <li class="slide">
                  ...
                  <li class="slide">
                    ...
                    <ul class="slide-menu">
                      ...
                      <li>
                        <a href="icons11.html" class="slide-item"
                          >Bootstrap Icons</a
                        >
                      </li>
                    </ul>
                          ...
                          <div class="card-body">
                            ...
                            <span class="text-muted fs-12"
                              ><span class="text-secondary"
                                ><i
                                  class="fe fe-arrow-up-circle text-secondary"
                                ></i>
                                5%</span
                              >
                              Last week</span
                          ...
                          <div class="card-body">
                            ...
                            <span class="text-muted fs-12"
                              ><span class="text-pink"
                                ><i
                                  class="fe fe-arrow-down-circle text-pink"
                                ></i>
                                0.75%</span
                              >
                              Last 6 days</span
                          ...
                          <div class="card-body">
                            ...
                            <span class="text-muted fs-12"
                              ><span class="text-green"
                                ><i
                                  class="fe fe-arrow-up-circle text-green"
                                ></i>
                                0.9%</span
                              >
                              Last 9 days</span
                          ...
                          <div class="card-body">
                            ...
                            <span class="text-muted fs-12"
                              ><span class="text-warning"
                                ><i
                                  class="fe fe-arrow-up-circle text-warning"
                                ></i>
                                0.6%</span
                              >
                              Last year</span
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 col-xl-9">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div
                          class="d-flex mx-auto text-center justify-content-center mb-4"
                        >
                          <div
                            class="d-flex text-center justify-content-center me-3"
                          >
                          ...
                          >
                            <span class="dot-label bg-secondary my-auto"></span
                            >Total Orders
                          </div>
                        </div>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12 col-xl-3">
                    <div class="card overflow-hidden">
                      ...
                      <div class="card-body">
                        ...
                        <div class="d-flex">
                          <div
                            class="avatar avatar-md bg-pink-transparent text-pink bradius me-3"
                          >
                            <i class="fe fe-x"></i>
                          </div>
                          <div class="">
                          ...
                          <li class="d-sm-flex">
                            <div>
                              ...
                              <h6 class="fw-semibold">
                                Task Finished<span
                                  class="text-muted fs-11 mx-2 fw-normal"
                                  >09 July 2021</span
                                >
                              </h6>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-12">
                    <div class="card overflow-hidden">
                      ...
                      <div class="card-body p-0 mt-2">
                        <div class="">
                          <div
                            id="world-map-markers1"
                            class="worldh world-map h-250"
                          ></div>
                        </div>
                          ...
                          <table class="table text-nowrap border-dashed mb-0">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td class="text-start p-4">
                                  <span
                                    class="sales-icon text-secondary mx-2 brround bg-secondary-transparent p-2"
                                    ><svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="18"
                                      height="18"
                              ...
                              <tr>
                                <td class="text-start p-4">
                                  <span
                                    class="sales-icon text-danger mx-2 brround bg-danger-transparent p-2"
                                    ><svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="18"
                                      height="18"
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="browser-stats">
                          <div class="row mb-4">
                            <div
                              class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3"
                            >
                              <img
                                src="admin/assets/images/browsers/chrome.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                            <div
                              class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0"
                            >
                              <div
                          ...
                          <div class="row mb-4">
                            ...
                            >
                              <img
                                src="admin/assets/images/browsers/opera.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                          ...
                          <div class="row mb-4">
                            ...
                            >
                              <img
                                src="admin/assets/images/browsers/ie.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                          ...
                          <div class="row mb-4">
                            ...
                            >
                              <img
                                src="admin/assets/images/browsers/firefox.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                          ...
                          <div class="row mb-4">
                            ...
                            >
                              <img
                                src="admin/assets/images/browsers/edge.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                          ...
                          <div class="row mb-4">
                            ...
                            >
                              <img
                                src="admin/assets/images/browsers/safari.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                          ...
                          <div class="row">
                            ...
                            >
                              <img
                                src="admin/assets/images/browsers/netscape.svg"
                                class="img-fluid"
                                alt="img"
                              />
                            </div>
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  ...
                                                  style="
                                                    background-image: url(admin/assets/images/orders/10.jpg);
                                                  "
                                                ></span>
                                                <div
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/12.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/4.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/8.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/6.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/1.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/11.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                                            ...
                                            <td>
                                              <div class="d-flex">
                                                <span
                                                  class="avatar bradius"
                                                  style="
                                                    background-image: url(admin/assets/images/orders/2.jpg);
                                                  "
                                                ></span>
                                                <div
                                                  class="ms-3 mt-0 mt-sm-2 d-block"
                    ...
                    <div class="browser-stats">
                      <div class="row mb-4">
                        <div class="col-sm-2 mb-sm-0 mb-3">
                          <span
                            class="feeds avatar-circle brround bg-primary-transparent"
                            ><i class="fe fe-user text-primary"></i
                          ></span>
                        </div>
                        <div class="col-sm-10 ps-sm-0">
                          <div
                            class="d-flex align-items-end justify-content-between ms-2"
                          >
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 mb-sm-0 mb-3">
                          <span
                            class="feeds avatar-circle avatar-circle-secondary brround bg-secondary-transparent"
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 mb-sm-0 mb-3">
                          <span
                            class="feeds avatar-circle avatar-circle-danger brround bg-danger-transparent"
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 mb-sm-0 mb-3">
                          <span
                            class="feeds avatar-circle avatar-circle-warning brround bg-warning-transparent"
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 mb-sm-0 mb-3">
                          <span
                            class="feeds avatar-circle avatar-circle-pink brround bg-pink-transparent"
                      ...
                      <div class="row">
                        <div class="col-sm-2 mb-sm-0 mb-3">
                          <span
                            class="feeds avatar-circle avatar-circle-info brround bg-info-transparent"
                  ...
                  <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          ...
                          data-bs-image-src="admin/assets/images/users/2.jpg"
                        ></span>
                      </div>
                      <div class="">
                        <a href="chat.html">
                    ...
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          class="avatar avatar-md brround cover-image"
                          data-bs-image-src="admin/assets/images/users/11.jpg"
                      ...
                      <div class="">
                        <a href="chat.html">
                          ...
                          <p class="mb-0 fs-12 text-muted">
                            Okayadmin.I will be waiting for you
                          </p>
                        </a>
                      </div>
                    </div>
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          class="avatar avatar-md brround cover-image"
                          data-bs-image-src="admin/assets/images/users/10.jpg"
                        ></span>
                      </div>
                      <div class="">
                        <a href="chat.html">
                          ...
                          <p class="mb-0 fs-12 text-muted">
                            Hi we can explain our new projectadmin
                          </p>
                        </a>
                      </div>
                    </div>
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          class="avatar avatar-md brround cover-image"
                          data-bs-image-src="admin/assets/images/users/13.jpg"
                        ></span>
                      </div>
                      <div class="">
                        <a href="chat.html">
                    ...
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          class="avatar avatar-md brround cover-image"
                          data-bs-image-src="admin/assets/images/users/7.jpg"
                          ><span class="avatar-status bg-success"></span
                        ></span>
                      </div>
                      <div class="">
                    ...
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          class="avatar avatar-md brround cover-image"
                          data-bs-image-src="admin/assets/images/users/9.jpg"
                        ></span>
                      </div>
                      <div class="">
                        <a href="chat.html">
                    ...
                    <div class="list-group-item d-flex align-items-center">
                      <div class="me-2">
                        <span
                          class="avatar avatar-md brround cover-image"
                          data-bs-image-src="admin/assets/images/users/14.jpg"
                        ></span>
                      </div>
                      <div class="">
                        <a href="chat.html">
                  ...
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/us_flag.jpg"
                  ...
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/italy_flag.jpg"
                          class="me-3 language" /></span
                      >Italy
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/spain_flag.jpg"
                          class="me-3 language" /></span
                      >Spain
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/india_flag.jpg"
                          class="me-3 language" /></span
                      >India
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/french_flag.jpg"
                          class="me-3 language" /></span
                      >French
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/russia_flag.jpg"
                          class="me-3 language" /></span
                      >Russia
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/germany_flag.jpg"
                          class="me-3 language" /></span
                      >Germany
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/argentina.jpg"
                          class="me-3 language" /></span
                      >Argentina
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/malaysia.jpg"
                          class="me-3 language" /></span
                      >Malaysia
                    </a>
                  </li>
                  <li class="col-lg-6 mb-2">
                    ...
                    >
                      <span class="country-selector"
                        ><img
                          alt=""
                          src="admin/assets/images/flags/turkey.jpg"
                          class="me-3 language" /></span
                      >Turkey
                    </a>
                  </li>
      ...
      <script src="admin/assets/plugins/chart/rounded-barchart.js"></script>
